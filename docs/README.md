...
- [Agent kickoff](agent-kickoff.md)

## Decisions

Accepted and proposed architectural decisions live under
[`docs/decisions/`](decisions/README.md). An issue tracks an unresolved decision; an
ADR records the durable result after it is settled.
